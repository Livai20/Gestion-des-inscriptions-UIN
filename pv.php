...
<!--Couleur d'arriere plan sous 'Enregistrements'-->
					<div class="btn btn-dark btn-block" style="background-color: lightgreen;">&nbsp;<h3><b>FACULTE D'AGRONOMIE</b></h3><i><h5><b>ANNEE UNVERSITAIRE: <?php echo $c; ?></b></h5></i><h4><b>LES ETUDIANTS INSCRITS EN <?php echo $id ?><?php if ($id==1) {
						echo 'ERE';}else{ echo 'EME';} ?> ANNEE</b></h4><h4><b>OPTION : PRODUCTION VEGETALE</b></h4></b></div><br>	
