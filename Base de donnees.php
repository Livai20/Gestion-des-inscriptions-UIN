...
<body>
	...
	<div class="row" style="background-color: transparent; box-shadow:inset -1px 1px 7px #444;"><br>
		<div class="text-center">
			<div class="btn btn-dark btn-block" style="background-color: lightgreen;">&nbsp;<h3><b>FACULTE DES SCIENCES ET TECHNIQUES</b></h3><i><h5><b>ANNEE UNVERSITAIRE: <?php echo $c; ?></b></h5></i><h4><b>LES ETUDIANTS INSCRITS A L'OPTION : BASE DE DONNEES</b></h4>
			</div><br>	
