...
$d=$cn->query("SELECT * from niveau where idfil='9' order by niveau"); 
...
<!--Couleur d'arriere plan sous 'Enregistrements'-->
					<div class="btn btn-dark btn-block" style="background-color: lightgreen;font-family: serif;border-radius: 30px">&nbsp;<b><h3>FACULTE D'AGRONOMIE</b></h3><i><h5><b>ANNEE UNVERSITAIRE: <?= $c; ?></b></h5></i><h4><b>SECTIONS</b></h4><h4><b>OPTION : PRODUCTION ANIMALE</b></h4></b></div>
				</div>
				<div class="col-md-offset-4 col-md-4" style="background-color: black; border-radius: 40px;">
			<?php 
				while($tabD=$d->fetch()){?>	
					<div>
						<a href="pa.php?id=<?php echo $tabD['niveau'] ?>">
